...
# created functional settings button and non-functional full and regular screen button
# created functional settings button and non-functional full and regular screen button
# created functional settings button and non-functional full and regular screen button
...
button_location = PVector((width / 2) - 50, (height / 2) - 50)
button_clicked = False
button_size = PVector(100, 50)

settings_location = PVector((width / 2) - 50, (height / 2) + 50)
...
def draw():
    ...
    if not settings_clicked and not button_clicked:
        fill(0)
    ...
    if settings_clicked:
        ...
        fill(255)
        textSize(16)
        text('Full screen', (width / 2) - 40, (height / 2) - 30)
        
        text('Regular', (width / 2) - 40, (height / 2) + 70)
    
    if not button_clicked and not settings_clicked:    
        fill(0)
        rect(button_location.x, button_location.y, button_size.x, button_size.y)
...
def mousePressed():
    global speed, mouse, player, button_clicked, settings_clicked
    ...
    button_end = PVector(button_location.x + button_size.x, button_location.y + button_size.y)
    if mouseX in range(int(button_location.x), int(button_end.x)):
        if mouseY in range(int(button_location.y), int(button_end.y)):
            button_clicked = True
